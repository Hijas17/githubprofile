...
const Profile = ({ user }: any) => {
  return (
    <div className="max-w-md h-auto mx-auto p-6 bg-[#0b323133] dark:bg-[#0b323133] rounded-lg shadow-lg text-center">
      ...
      <h2 className="mt-2 text-sm text-[rgb(110,127,153)] dark:text-[rgb(75,87,107)]">{user.email?user.email:"Email not provided or set to private. Please check your profile."}</h2>
      ...
      <div className="flex justify-around mt-4 text-sm text-[rgb(123,145,175)] dark:text-[rgb(60,69,83)]">
      ...
      <div className="relative flex justify-around mt-4 text-[rgb(110,127,153)] dark:text-[rgb(75,87,107)]">
        <Link
